    ...
    <div class="login-wrapper">
        ...
        <div id="myTabContent" class="tab-content bn">
            <div class="tab-pane fade active in" id="log-in">
                <form class="form-horizontal mt10" action="${pageContext.request.contextPath}/j_spring_security_check"
            ...
            <div class="tab-pane fade" id="register">
                <form class="form-horizontal mt20" action="/user/register" id="register-form" role="form">
                    <div class="form-group">
                        <div class="col-lg-12">
                            <!-- col-lg-12 start here -->
                            <input id="usernameR" name="usernameR" type="text"
                    ...
                    <div class="form-group">
                        <div class="col-lg-12">
                            <!-- col-lg-12 start here -->
                            <input id="alipayno" name="alipayno" type="text" class="form-control left-icon"
                                   placeholder="支付宝帐号" pattern="0?(13|14|15|18)[0-9]{9}"
                                   required oninvalid="this.setCustomValidity('请输入正确的支付宝帐号！');">
                            <i class="ec-mail s16 left-input-icon"></i>
                        </div>
                        <!-- col-lg-12 end here -->
                    </div>
                    <div class="form-group">
                        <div class="col-lg-12">
                            <!-- col-lg-12 start here -->
                            <input type="password" class="form-control left-icon" id="password2" name="password2"
                                   placeholder="输入密码（5~10位）" pattern="^.{5,10}$" required
                                   oninvalid="this.setCustomValidity('输入密码（5~10位）！');">
                            <i class="ec-locked s16 left-input-icon"></i>
                        </div>
                        <!-- col-lg-12 end here -->
                        <div class="col-lg-12 mt15">
                            <!-- col-lg-12 start here -->
                            <input type="password" class="form-control left-icon" id="password3" name="password3"
                                   placeholder="重复密码" pattern="^.{5,10}$ " required
                                   oninvalid="this.setCustomValidity('输入密码（5~10位）！');">
                            <i class="ec-locked s16 left-input-icon"></i>
                        </div>
                        <!-- col-lg-12 end here -->
