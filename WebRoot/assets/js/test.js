//省、市、区 
var region_init = function (select_province, select_city, select_area, select_province_default, select_city_default, select_area_default) {
    var region_p = document.getElementById(select_province);
    var region_c = document.getElementById(select_city);
    var region_d = document.getElementById(select_area);
    ...
    function region_c_change() {
        ...
        option_items_select(region_d, select_area_default);
    }
    ...
    function region_p_change() {
        ...
        option_items_select(region_c, select_city_default);
        region_c_change();
    ...
    option_items_select(region_p, select_province_default);
    region_p_change();
